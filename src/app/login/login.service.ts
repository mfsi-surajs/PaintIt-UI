...
export class LoginService{
    ...
    userLogin(username,password){
        ...
        return this._http.post("http://localhost:8080/paintingApis/login",bodyString,this.options)
    ...
    userSignUp(user){
        ...
        return this._http.post("http://localhost:8080/paintingApis/addUser",userString,this.options)
            .map((response:Response) => response.json());
    }
